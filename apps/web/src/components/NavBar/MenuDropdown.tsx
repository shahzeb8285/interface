          ...
          <NavDropdown top={{ sm: 'unset', lg: '56' }} bottom={{ sm: '50', lg: 'unset' }} right="0">
            <Column gap="8">
              ...
              <Box
                ...
                paddingX="8"
              >
                <SecondaryLinkedText href="https://hotkeyswap.gitbook.io/">
                Gitbook ↗
                </SecondaryLinkedText>
                <SecondaryLinkedText href="https://app.hotkeyswap.com">
                dApp ↗
                </SecondaryLinkedText>
                <SecondaryLinkedText href="https://t.me/HotKeySwapBot">
                MiniApp ↗
                </SecondaryLinkedText>
                {/* <SecondaryLinkedText
                  onClick={() => {
              ...
              <IconRow>
                <Icon href="https://t.me/HotKeySwap">
                  <TelegramIcon className={styles.hover} width={24} height={24} color={themeVars.colors.neutral2} />
                </Icon>
                <Icon href="https://x.com/hotkeyswap">
