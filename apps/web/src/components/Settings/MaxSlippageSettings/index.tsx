...
const MINIMUM_RECOMMENDED_SLIPPAGE = new Percent(150, 10000)
const MAXIMUM_RECOMMENDED_SLIPPAGE = new Percent(150, 1000)
...
export default function MaxSlippageSettings({ autoSlippage }: { autoSlippage: Percent }) {
  ...
  const defaultSlippageInputValue =formatPercentInput(userSlippageTolerance)
  ...
  const tooLow =userSlippageTolerance.lessThan(MINIMUM_RECOMMENDED_SLIPPAGE)
