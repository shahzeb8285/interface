...
const ReferralDetails = lazy(() => import('pages/ReferralPage'))
...
export const routes: RouteDefinition[] = [
  ...
  createRouteDefinition({
    path: '/',
    getElement: () => <Swap />,
    getTitle: () => 'Buy, Sell & Trade Top Tokens on HotKeySwap',
  }),
  createRouteDefinition({
    path: '/explore',
  ...
  createRouteDefinition({
    ...
    getTitle: getDefaultTokensTitle,
    getElement: (args) => {
      return args.infoExplorePageEnabled ? <RedirectExplore /> : <ReferralDetails />
    },
  }),
  //
  createRouteDefinition({
