...
export const REFERRAL_MANAGER_ADDRESS: AddressMap = {
  [ChainId.GOERLI]: '0x80fA759FD5E7Ead97143a31112913A9f0201909b'
}
 ...
 */
export const SUPPORTED_V2POOL_CHAIN_IDS = [ChainId.MAINNET, ChainId.GOERLI,ChainId.POLYGON_MUMBAI] as const
